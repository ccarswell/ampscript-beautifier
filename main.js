	...
	function pegjs(text) {
        ...
        [peg$otherExpectation(description)],
			...
			function peg$parseSpaces20() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 19) === peg$c49) {
					s1 = peg$c49;
					peg$currPos += 19;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces21() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 20) === peg$c51) {
					s1 = peg$c51;
					peg$currPos += 20;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces24() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 23) === peg$c57) {
					s1 = peg$c57;
					peg$currPos += 23;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces25() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 24) === peg$c59) {
					s1 = peg$c59;
					peg$currPos += 24;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces27() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 26) === peg$c63) {
					s1 = peg$c63;
					peg$currPos += 26;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces28() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 27) === peg$c65) {
					s1 = peg$c65;
					peg$currPos += 27;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces29() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 28) === peg$c67) {
					s1 = peg$c67;
					peg$currPos += 28;
				} else {
					s1 = peg$FAILED;

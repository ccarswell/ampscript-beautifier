define(function (require) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c2 = function(startscript) {return '%%['},
        peg$c3 = /^[()]/,
        ...
        peg$c8 = function(text) {return text.join("")},
        peg$c9 = /^[\n]/,
        peg$c10 = peg$classExpectation(["\n"], false, false),
        peg$c11 = function(text) {return '@@LINEBREAK'},
        peg$c12 = /^[\t]/,
        peg$c13 = peg$classExpectation(["\t"], false, false),
        peg$c14 = function(text) {return '@@INDENT'},
        peg$c15 = "  ",
        ...
        peg$c33 = function(endscript) {return ']%%'},
    ...
    function peg$parseText() {
      ...
      if (s0 === peg$FAILED) {
        ...
        if (s0 === peg$FAILED) {
          s0 = peg$parseIndent();
          if (s0 === peg$FAILED) {
            s0 = peg$parseIndentType9();
            if (s0 === peg$FAILED) {
              s0 = peg$parseIndentType8();
              if (s0 === peg$FAILED) {

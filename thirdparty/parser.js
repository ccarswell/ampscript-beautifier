...
---------------
  ...
  Generated by Christopher Carswell using PegJS
  	https://pegjs.org/
	...
	var parse = function (text) {
		...
		function peg$parse(input, options) {
			...
			var peg$FAILED = {},
				...
				peg$c92 = /^[ \r ]/,
				peg$c93 = peg$classExpectation([" ", "\r", " "], false, false),
        ...
        [peg$otherExpectation(description)],
			...
			function peg$parseSpaces17() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 16) === peg$c63) {
					s1 = peg$c63;
					peg$currPos += 16;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces19() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 18) === peg$c67) {
					s1 = peg$c67;
					peg$currPos += 18;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces20() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 19) === peg$c69) {
					s1 = peg$c69;
					peg$currPos += 19;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces23() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 22) === peg$c75) {
					s1 = peg$c75;
					peg$currPos += 22;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces24() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 23) === peg$c77) {
					s1 = peg$c77;
					peg$currPos += 23;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces26() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 25) === peg$c81) {
					s1 = peg$c81;
					peg$currPos += 25;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces27() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 26) === peg$c83) {
					s1 = peg$c83;
					peg$currPos += 26;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces28() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 27) === peg$c85) {
					s1 = peg$c85;
					peg$currPos += 27;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces29() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 28) === peg$c87) {
					s1 = peg$c87;
					peg$currPos += 28;
				} else {
					s1 = peg$FAILED;
			...
			function peg$parseSpaces30() {
				...
				s0 = peg$currPos;
				if (input.substr(peg$currPos, 29) === peg$c89) {
					s1 = peg$c89;
					peg$currPos += 29;
				} else {
					s1 = peg$FAILED;
